...
export default class extends Phaser.State {
  ...
  create () {
    ...
    const gameOverText = this.createText(this.game.world.width / 2, this.game.world.centerY, 'center', 'CONGRATULATIONS, YOU WON!').anchor.set(0.5, 0.5)
    ...
    audioManager.playSoundEffect(this.game, 'victory')
  }
